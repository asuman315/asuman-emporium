...
export default function ProductCard({product}) {
  ...
  return (
    <div className="text-md mb-4 relative rounded-md shadow-lg p-5 bg-white">
      <Link to={`/products/${product.handle}`}>
        <div className="border-gray-200 mb-2 relative flex items-center justify-center overflow-hidden object-cover h-96">
